...
public class HourlyWeatherCommand implements Command {
    private Logger logger = org.apache.log4j.Logger.getLogger(HourlyWeatherCommand.class);
    ...
    public String execute(Update update) {
        ...
        return ForecastUtil.getForecastInfoHourly(forecast, getCoordinatesName(latLng));
    }
}
