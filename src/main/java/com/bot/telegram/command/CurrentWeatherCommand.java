...
import com.bot.telegram.util.MapUtil;
...
public class CurrentWeatherCommand implements Command {
    private Logger logger = org.apache.log4j.Logger.getLogger(CurrentWeatherCommand.class);
    ...
    public String execute(Update update) {
        ...
        return ForecastUtil.getForecastInfoCurrently(forecast, getCoordinatesName(latLng));
    }
